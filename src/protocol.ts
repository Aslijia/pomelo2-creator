;(function (exports: any, ByteArray, global: any) {
    const Protocol: any = exports
    ...
    const Package: any = (Protocol.Package = {})
    const Message: any = (Protocol.Message = {})
     ...
     */
    Protocol.strencode = function (str: string) {
     ...
     */
    Protocol.strdecode = function (buffer: string) {
        if (typeof Buffer !== 'undefined' && ByteArray === Buffer) {
            // encoding defaults to 'utf8'
     ...
     */
    Package.encode = function (type: number, body: any) {
     ...
     */
    Package.decode = function (buffer: string) {
        let offset = 0
        const bytes = new ByteArray(buffer)
        let length = 0
        const rs = []
     ...
     */
    Message.encode = function (id: number, type: number, compressRoute: number, route: string, msg: any, compressGzip: any) {
     ...
     */
    Message.decode = function (buffer: any) {
        ...
        if (msgHasId(type)) {
            ...
            var i = 0
            do {
                m = parseInt(bytes[offset].toString())
                id += (m & 0x7f) << (7 * i)
                offset++
                i++
            } while (m >= 128)
        ...
        return { id: id, type: type, compressRoute: compressRoute, route: route, body: body, compressGzip: compressGzip }
    }

    var copyArray = function (dest: any, doffset: number, src: any, soffset: number, length: number) {
    ...
    var msgHasId = function (type: number) {
        return type === Message.TYPE_REQUEST || type === Message.TYPE_RESPONSE
    }

    var msgHasRoute = function (type: number) {
        return type === Message.TYPE_REQUEST || type === Message.TYPE_NOTIFY || type === Message.TYPE_PUSH
    }

    var caculateMsgIdBytes = function (id: number) {
        var len = 0
        do {
            len += 1
            id >>= 7
    ...
    var encodeMsgFlag = function (type: number, compressRoute: number, buffer: any, offset: number, compressGzip: any) {
    ...
    var encodeMsgId = function (id: number, buffer: any, offset: number) {
        do {
            var tmp = id % 128
    ...
    var encodeMsgRoute = function (compressRoute: number, route: any, buffer: any, offset: number) {
        if (compressRoute) {
    ...
    var encodeMsgBody = function (msg: any, buffer: any, offset: number) {
