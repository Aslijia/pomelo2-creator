...
class Session extends events_1.EventEmitter {
    ...
    _encode(reqId, route, msg) {
        ...
        return protocol_1.Protocol.Message.encode(reqId, reqId ? protocol_1.Protocol.MessageType.TYPE_REQUEST : protocol_1.Protocol.MessageType.TYPE_NOTIFY, this.dict[route], this.dict[route], msg, false);
    }
    _decode(buffer) {
